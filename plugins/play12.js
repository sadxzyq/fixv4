...
⬡ Upload: ${publishedTime}
⬡ Link: ${vid.url}
╰────────⬣`, author.trim(), await( await conn.getFile(thumbnail)).data, ['📽VIDEO', `${usedPrefix}getvid ${url} 360`], false, { quoted: m, 'document': { 'url':'https://wa.me/6282285357346' },
'mimetype': global.dpdf,
'fileName': `𝕐𝕠𝕦𝕋𝕦𝕓𝕖 ℙ𝕝𝕒𝕪𝕤`,
'fileLength': 0,
'pageCount': 0,contextInfo: { externalAdReply: { showAdAttribution: true,
mediaType:  2,
mediaUrl: `${url}`,
title: `AUDIO SEDANG DIKIRIM...`,
body: wm,
sourceUrl: 'http://wa.me/6282285357346', thumbnail: await ( await conn.getFile(thumbnail)).data
  }
 } 
})
